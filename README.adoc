...
You will build a msgs.js client that consumes a Spring-based messaging service that uses the STOMP protocol over WebSocket. Specifically, the client will exchanges messages with the service created in
